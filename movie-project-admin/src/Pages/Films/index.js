...
import { fetchFilmList } from "../../Redux/action/QuanLyFilmsAction";
                            ...
                            movieList?.items?.map((movie, index) => {
                                return <TableRow key={index}>
                                    ...
                                    <TableCell align="right">
                                        <Button className={classes.buttonEdit}  variant="contained" startIcon={<Edit/>}>Edit</Button>
                                        <Button className={classes.buttonDelete} variant="contained" startIcon={<Delete/>}>Delete</Button>
                                    </TableCell>
                                    </TableRow>
                            })}
                    </TableBody>
