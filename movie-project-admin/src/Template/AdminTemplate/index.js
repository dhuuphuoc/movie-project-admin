                  ...
                  <ul className="navbar-nav ms-auto my-3 my-lg-0">
                    <li className="nav-item dropdown">
                      ...
                      >
                        ...
                        <span>Hello, {adminSignin.taiKhoan}</span>
                      </a>
                      <ul
                      ...
                      >
                        <li>
                          <a
                            className="dropdown-item text-up"
                            onClick={() => {
                              dispatch(signOut());
                            }}
                          >
                  ...
                  <nav className="navbar-dark mt-5">
                    <ul className="navbar-nav">
                      ...
                      >
                        ...
                        <NavLink className="bg-color-1" to="/admin">
                          Dashboard
                        </NavLink>
                      </li>
                      <li className="my-4">
                      ...
                      >
                        ...
                        <NavLink className="bg-color-1" to="/admin/users">
                          User
                        </NavLink>
                      </li>
                      <li className="my-4">
                      ...
                      >
                        ...
                        <NavLink className="bg-color-1" to="/admin/films">
                          Movie
                        </NavLink>
                      </li>
                    </ul>
